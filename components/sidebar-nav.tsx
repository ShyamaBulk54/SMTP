...
export function SidebarNav({ isMobile = false }: SidebarNavProps) {
  ...
  return (
    <div className="flex h-full w-64 flex-col border-r border-border bg-card">
      ...
      <div className="flex items-center justify-center px-4 py-3 h-16">
        <Image src="/smtplogo.jpg" alt="SMTP Master" width={120} height={32} className="h-25 w-auto object-contain" />
      </div>
      {sidebarContent}
    </div>
  )
