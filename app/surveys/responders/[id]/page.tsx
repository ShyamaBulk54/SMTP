...
import SurveyRespondersContent from "@/components/survey-responders-content"
import MobileSidebar from "@/components/mobile-sidebar"

export default function SurveyRespondersPage({ params }: { params: { id: string } }) {
  return (
    <div className="flex h-screen bg-background">
      ...
      <div className="flex-1 overflow-auto">
        ...
        <main className="p-4 sm:p-6">
          <SurveyRespondersContent surveyId={params.id} />
        </main>
      </div>
    </div>
  )
